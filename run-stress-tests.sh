...
./empty_service_tests.py --host $NODE crud -n 1000 --json results/empty-service-crud-10-local.json
./empty_service_tests.py --host $NODE clean

./python_service_tests.py --host $NODE crud -n 100 --json results/python-service-crud-10-local.json
