package com.example.emptyjavaservice;

import com.example.emptyjavaservice.namespaces.*;
...
public class emptyjavaserviceRFS {
    ...
    @ServiceCallback(servicePoint="empty-java-service-servicepoint",
